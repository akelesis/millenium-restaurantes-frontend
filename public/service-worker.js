    ...
    request.onsuccess = function() {
      ...
      objectStore.getAll().onsuccess = function(event){
        ...
        for(let dt of data){
          ...
          .then(res => {
            if(res.ok){
              const transactionDelete = db.transaction('sync-invoices', 'readwrite')
              const objectStoreDelete = transactionDelete.objectStore('sync-invoices')
